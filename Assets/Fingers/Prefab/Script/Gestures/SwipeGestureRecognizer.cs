...
namespace DigitalRubyShared
{
    ...
    public class SwipeGestureRecognizer : DigitalRubyShared.GestureRecognizer
    {
        ...
        {
            if (ThresholdSeconds > 0.0f && timer.Elapsed.TotalSeconds > ThresholdSeconds)
            {
                SetState(GestureRecognizerState.Failed);
                return;
            }
        ...
        /// <summary>
        /// The threshold in seconds that the swipe must execute in before failing. Default is 0 which means no threshold.
        /// </summary>
