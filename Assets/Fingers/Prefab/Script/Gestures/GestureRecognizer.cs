...
namespace DigitalRubyShared
{
    ...
    public struct GestureTouch : IComparable<GestureTouch>
    {
        ...
        /// <param name="platformSpecificTouch">Platform specific touch object</param>
        /// <param name="touchPhase">Touch phase</param>
        /// <param name="deviceId">Device id, 0 for default</param>
        public GestureTouch(int platformSpecificId, float screenX, float screenY, float previousX, float previousY, float pressure = 1.0f,
            object platformSpecificTouch = null, TouchPhase touchPhase = TouchPhase.Unknown, int deviceId = 0)
        {
        ...
        /// <summary>
        /// Device id (0 for default) - touches on different device ids cannot match for a gesture
        /// </summary>
    ...
    /// </summary>
    public class GestureRecognizer : IDisposable, IComparable<GestureRecognizer>
    {
        private static readonly DigitalRubyShared.GestureRecognizer allGesturesReference = new DigitalRubyShared.GestureRecognizer();
        private static readonly HashSet<int> consumedTouches = new HashSet<int>();
        ...
        private int TrackTouchesInternal(IEnumerable<GestureTouch> touches)
        {
            ...
            foreach (GestureTouch touch in touches)
            {
                ...
                if ((DeviceId <= 0 || DeviceId == touch.DeviceId) &&
                    (State == GestureRecognizerState.Possible || currentTrackedTouches.Count < MaximumNumberOfTouchesToTrack) &&
                    !currentTrackedTouches.Contains(touch) && !consumedTouches.Contains(touch.Id))
                {
...
#pragma warning restore 0618
        ...
        /// <summary>
        /// Consume a touch so that it is no longer processed
        /// </summary>
        /// <param name="id">Touch id to consume</param>
        public static void ConsumeTouch(int id)
        {
            consumedTouches.Add(id);
        }

        /// <summary>
        /// Remove a touch from consumption, allowing it to process again
        /// </summary>
        /// <param name="id">Touch id to unconsume</param>
        public static void UnconsumeTouch(int id)
        {
            consumedTouches.Remove(id);
        }

        /// <summary>
        /// Compare by priority
        /// </summary>
        /// <param name="other">Other gesture recognizer</param>
        /// <returns>CompareTo result</returns>
        ...
        /// <summary>
        /// Gesture priority - lower priority execute first
        /// </summary>
        ...
        /// <summary>
        /// User specified tag, similar to CustomData
        /// </summary>
